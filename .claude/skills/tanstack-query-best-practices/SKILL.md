...
Read the relevant rule file for detailed guidance and code examples:

- [qk-array-structure](./rules/qk-array-structure.md)
- [qk-include-dependencies](./rules/qk-include-dependencies.md)
- [qk-hierarchical-organization](./rules/qk-hierarchical-organization.md)
- [qk-factory-pattern](./rules/qk-factory-pattern.md)
- [qk-serializable](./rules/qk-serializable.md)
- [cache-stale-time](./rules/cache-stale-time.md)
- [cache-gc-time](./rules/cache-gc-time.md)
- [cache-invalidation](./rules/cache-invalidation.md)
- [cache-placeholder-vs-initial](./rules/cache-placeholder-vs-initial.md)
- [mut-invalidate-queries](./rules/mut-invalidate-queries.md)
- [mut-optimistic-updates](./rules/mut-optimistic-updates.md)
- [mut-mutation-state](./rules/mut-mutation-state.md)
- [err-error-boundaries](./rules/err-error-boundaries.md)
- [pf-intent-prefetch](./rules/pf-intent-prefetch.md)
- [inf-page-params](./rules/inf-page-params.md)
- [ssr-dehydration](./rules/ssr-dehydration.md)
- [parallel-use-queries](./rules/parallel-use-queries.md)
- [query-cancellation](./rules/query-cancellation.md)
- [perf-select-transform](./rules/perf-select-transform.md)
- [network-mode](./rules/network-mode.md)
- [persist-queries](./rules/persist-queries.md)
