    ...
    <main className="flex h-svh flex-col overflow-hidden bg-background text-foreground">
      ...
      >
        <ResizablePanel defaultSize={17} minSize={12}>
          <aside className="flex h-full min-h-0 flex-col overflow-y-auto px-3 py-3">
            {rail}
          </aside>
        </ResizablePanel>
        <ResizableHandle className="bg-border" />
        <ResizablePanel defaultSize={53} minSize={30}>
          <section className="flex h-full min-h-0 flex-col overflow-y-auto px-4 py-3">
            {queue}
          </section>
        </ResizablePanel>
        <ResizableHandle className="bg-border" />
        <ResizablePanel defaultSize={30} minSize={20}>
          <aside className="flex h-full min-h-0 flex-col overflow-y-auto">
            {dossier}
          </aside>
        </ResizablePanel>
      </ResizablePanelGroup>
