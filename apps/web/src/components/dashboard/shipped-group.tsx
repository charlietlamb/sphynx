...
export function ShippedGroup({ gap, now, onOpenNumber }: ShippedGroupProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <p className="mb-1 flex items-baseline gap-2 border-border border-b px-2.5 pt-1 pb-2 text-[11px] text-muted-foreground/60">
      ...
      {gap.directCommits > 0 || extra > 0 ? (
        <p className="px-2.5 text-[11px] text-muted-foreground/50">
          {gap.directCommits > 0
