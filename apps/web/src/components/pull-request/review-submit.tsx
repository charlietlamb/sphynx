...
export function ReviewSubmit({
  ...
  return (
    <div className="relative shrink-0">
      ...
      {open ? (
        <div className="fade-in slide-in-from-top-1 absolute top-full right-0 z-50 mt-2 flex w-80 animate-in flex-col gap-2.5 rounded-lg bg-popover p-3.5 text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-150">
