...
CREATE TABLE "review_pull" (
	...
	"ci_failed" integer DEFAULT 0 NOT NULL,
	"ci_passed" integer DEFAULT 0 NOT NULL,
	"ci_pending" integer DEFAULT 0 NOT NULL,
	"unresolved_threads" integer DEFAULT 0 NOT NULL,
